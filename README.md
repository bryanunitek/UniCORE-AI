...
- 2026-05-12 (56bdbd3) — docs: link whitepaper from README
- 2026-05-12 (66bce96) — docs: link AI-AUTHORSHIP.md from README
- 2026-05-13 (23e2e55) — governance: add STATEMENT-ON-CLAIMS.md
- 2026-05-13 (9cfbb8f) — governance: add HORIZON.md
- 2026-05-13 (5b8eaae) — docs: add Deployment principles section linking to TrueAI 057/058
- 2026-05-13 (0d5508c) — docs: rename all 20 docs to 5-digit numeric codes, drop letter codes
- 2026-05-13 (785454d) — docs: update deployment principles links to TrueAI 10xxx namespace
- 2026-05-13 (ab3923e) — docs: point deployment-principles links at UniVERSE canonical
...
- 2026-05-13 (9d28712) — docs(README): point readers at the UniVERSE Certified Experts register
- 2026-05-14 (0fd3c4c) — docs: add LANDSCAPE.md (mirror) — AI governance landscape comparison
- 2026-05-15 (0d1ca89) — docs: add 20001 and 20002 to Architecture Documents index
- 2026-05-16 (3e574c5) — docs: prepend canonical UniCORE simple-mission to README
- 2026-05-17 (e928cfb) — Align licence-companion docs with CC BY 4.0; add Brand and Trademark Use Policy
- 2026-05-21 (2781275) — docs: add UniCORE Positioning Principle with badge-denial-on-military clause
- 2026-05-21 (d0243af) — docs: add UniCORE + UniCORE.GVB to Related Repositories (Sanity Check #002 F1)
- 2026-05-23 (a0ce9b1) — docs(readme): add cross-reference pointer to UniVERSE/GETTING_STARTED.md
- 2026-06-03 (12e3823) — docs: add UniSaaS sister repos to Related Repositories
- 2026-06-15 (407f25f) — docs(README): add Three Pillars framing block — Audience / Truth / Inconsistency
- 2026-06-19 (6339c99) — docs(README): add strap-line to 'Why...' section
