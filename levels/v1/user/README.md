...
**Per-Level corpus for User-scope agents in the UniCORE AI 12-level governance model — v1.**

Published: 2026-05-16

This folder is the home for the markdown content that defines **what a User-scope agent is**. User is the leaf scope below Level 01 — the scope at which agents serve end users directly, rather than operating within the 12 governance Levels.

## User-scope is multi-role
