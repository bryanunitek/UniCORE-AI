...
- 2026-07-03 (ae6350d) — Add AI-MATURITY-LEVELS.md — six-level AI maturity framework (Consumer AI to Team UniCORE), AI-Compliance floor, liability thesis. CC BY 4.0 public foundation.
- 2026-07-03 (2a30397) — Add governance decimal scale 5.00→6.0; Load Boundary; updated framework notes (2026-07-03 09:15 UTC, Bryan)
- 2026-07-03 (fd671c4) — Anonymise practical example — use Client A instead of personal name (2026-07-03 Bryan-direct)
- 2026-07-03 (5453c1c) — docs(ai-maturity): decimal scale = COUNT of Governance Levels operating, with tiered acceptance tests
- 2026-07-03 (06a17e5) — docs(maturity): add Maturity Icons legend — one emoji per level (1.0–6.0), clock-hour = count of 12 Governance Levels operating
- 2026-07-03 (923c2f8) — docs(maturity): clarify 1H1C is the structure (present at every level), not something that forms at 6.0 — maturity measures the pair's governance depth
- 2026-07-04 (0a3459a) — AI-MATURITY-LEVELS: 6.0 maturity icon = blue shield 🛡️ (was handshake)
- 2026-07-08 (a147b40) — AI-Maturity: define second octave (7.x/8.x, levels 13-24) — 7.13-7.24 Development, 8.0 Badge Certified, 8.13-8.24 above-commercial (reserved); replaces 'beyond 6.0' stub with defined two-octave model (Bryan-directed 2026-07-08 09:25 UTC)
- 2026-07-08 (80b7d98) — AI-Maturity: reorder second-octave band list sequentially (5->6->7->8) for readability — no meaning change (Bryan-directed 2026-07-08 09:30 UTC)
- 2026-07-08 (3ce62f0) — AI-Maturity: retire 5.12 = 6.0 equivalence — whole-number=KIND (5 Development / 6 Badge Certified), decimal=count of governance levels; 5.12=precondition, 6.0=vertical-cert flip, 6.01-6.12=commercial-certified band; shield colour distinguishes octaves (6.x blue / 8.x distinct); unicore is 5.x not certified (Bryan-ratified 2026-07-08 10:18 UTC)
- 2026-07-08 (1f8845c) — AI-Maturity: add redundancy model — 2x6.0 / 2x8.0 (systems whose failure is unacceptable = two independent certified pairs at the Badge gate; governance-layer form of the no-single-point-of-failure invariant) (Bryan-directed 2026-07-08 10:20 UTC)
- 2026-07-08 (836010a) — AI-Maturity: add soft/hard post governance — 12-Level walk, reprocess-on-inconsistency (AI-side OR human-side), daily-compounding consistency from mandatory logging, human-authorised hard post (authority does not migrate) (Bryan-directed 2026-07-08 10:32 UTC)
