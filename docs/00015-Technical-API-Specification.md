> **Canonical home:** [UniVERSE — `docs/00015-Technical-API-Specification.md`](https://git.unitek-systems.com/UniCORE/UniVERSE/src/branch/main/docs/00015-Technical-API-Specification.md) (mirror: [GitHub](https://github.com/bryanunitek/UniVERSE/blob/main/docs/00015-Technical-API-Specification.md))
