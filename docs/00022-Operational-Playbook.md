> **Canonical home:** [UniVERSE — `docs/00022-Operational-Playbook.md`](https://git.unitek-systems.com/UniCORE/UniVERSE/src/branch/main/docs/00022-Operational-Playbook.md) (mirror: [GitHub](https://github.com/bryanunitek/UniVERSE/blob/main/docs/00022-Operational-Playbook.md))
