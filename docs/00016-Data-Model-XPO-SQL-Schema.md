> **Canonical home:** [UniVERSE — `docs/00016-Data-Model-XPO-SQL-Schema.md`](https://git.unitek-systems.com/UniCORE/UniVERSE/src/branch/main/docs/00016-Data-Model-XPO-SQL-Schema.md) (mirror: [GitHub](https://github.com/bryanunitek/UniVERSE/blob/main/docs/00016-Data-Model-XPO-SQL-Schema.md))
