...
**Human-readable manifest of UniCORE-AI `developer-doctrine/v1/`.**

This file lists every document in the `developer-doctrine/v1/` folder, with a one-line description of each. For machine-parseable metadata, see [`MANIFEST.json`](MANIFEST.json).
